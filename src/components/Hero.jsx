        ...
        <section id="home" className='{`flex md:flex-row flex-col ${styles.paddingY}`}'>
          <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <div className='flex flex-row justify-between items-center w-[50%]'>
              ...
              <div className='ss:flex hidden md:mr-4 mr-0 ml-[15px]'>
                <GetStarted/>
              </div>
            </div>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
              Our team of expert uses a methodology to 
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
              <div id="divImgRobot">
                <img src={robot} alt="billing" className='w-[100%] h-[100%] relative z-[5]' id='imgRobot'/>
              </div>
          ...
          <div className={`ss:hidden ${styles.flexCenter}`} id="divGetStartedHidden">
            <GetStarted/>
          </div>
        </section>
      </>
